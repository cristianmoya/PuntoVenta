...
{
    public partial class frm_Diagnostico_Cita : Form
    {
        public frm_Diagnostico_Cita()
        {
            InitializeComponent();
        }
        ...
        private void txtIDPacie_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtNombPacie_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar == (char)',') || //coma decimal
            (e.KeyChar == (char)'.')) //no permite poner (punto)
            {
